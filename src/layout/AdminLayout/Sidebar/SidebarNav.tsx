...
export default function SidebarNav() {
  return (
    <ul className="list-unstyled">
      ...
      <SidebarNavItem icon={faFile} href="/docsregistrados">Documentos Registrados</SidebarNavItem>

      <SidebarNavItem icon={faFileLines} href="#">Documentos Pendientes</SidebarNavItem>

      {/* <SidebarNavItem icon={faPuzzlePiece} href="#">Configuraciones</SidebarNavItem> */}
    </ul>
  )
}
